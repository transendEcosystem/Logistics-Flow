...
import { Loader2, Truck, RefreshCcw, Search, ArrowRight, ShieldCheck, MapPin } from 'lucide-react';
...
export default function TransportOversight() {
    ...
    const loadData = useCallback(async () => {
        ...
        try {
            ...
            if (!token) return;
            const res = await performAdminAction(token, 'searchRegistry', { type: 'transporter', limit: 500 });
            setRecords(res.data || []);
        } catch (e) {
            console.error(e);
        } finally {
            ...
            cell: ({ row }) => (
                <div className="flex flex-col text-left">
                    ...
                    <div className="flex items-center gap-1.5 mt-1">
                        <Badge variant="outline" className="text-[8px] h-3.5 uppercase font-black border-primary/20 text-primary">Arterial Spokes</Badge>
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <div className="flex items-center gap-2">
                    <Badge className="bg-green-600 text-white text-[8px] h-4 font-black uppercase">RC1 Verified</Badge>
            ...
            <div className="flex justify-between items-end">
                <div className="text-left">
                    <h1 className="text-3xl font-black font-headline tracking-tight flex items-center gap-3">
                        ...
                        Transport Mall Oversight
                    </h1>
                    <p className="text-muted-foreground mt-1">Management of long-haul arterial fleet capacity and arterial spoke nodes.</p>
                </div>
