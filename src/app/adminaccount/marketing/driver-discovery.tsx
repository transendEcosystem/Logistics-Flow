...
YOU MUST PERFORM A LIVE SEARCH FOR "${category} professionals in South Africa" on LinkedIn and industrial registries.
...
2. HUB VERIFICATION: Map them to a specific industrial region.
3. IDENTITY: Extract the ACTUAL FULL NAME.
4. CONTACTS: Identify verified email and direct mobile numbers.
            ...
            <div className="space-y-4 text-left">
                ...
                <Alert className="bg-primary/5 border-primary/20 text-left">
                    ...
                    <AlertDescription className="text-xs text-left text-muted-foreground">
                        The agent is commanded to ignore general news and job listings.
                    </AlertDescription>
                </Alert>
...
export default function DriverDiscoveryEngine() {
    return (
        <Card className="shadow-none border-none text-left text-foreground">
            <Tabs defaultValue="Code 14 Driver" className="w-full text-left">
                <CardHeader className="px-0 pt-0 text-left text-foreground">
                    ...
                    <CardDescription className="text-left text-muted-foreground text-foreground">
                        Identify verified industrial talent using noise-suppressed discovery.
                    </CardDescription>
                </CardHeader>
