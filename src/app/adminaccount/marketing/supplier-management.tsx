...
export default function SupplierManagement() {
  ...
  const DEFAULT_DEMO_SUPPLIERS = useMemo(() => [
    {
      id: 'sup-demo-001',
      ...
      minedServiceWording: 'Bulk diesel, lubricants & fleet fuel management solutions across Southern Africa.',
    ...
    },
    {
      ...
      minedServiceWording: 'Commercial truck tyres, retreading services and fleet tyre management systems.',
    ...
    },
    {
      ...
      minedServiceWording: 'Genuine OEM heavy vehicle spare parts, engine components and chassis assemblies.',
      address: 'Aeroton, Johannesburg, South Africa',
      status: 'active',
      type: 'supplier',
      source: 'Member',
      updatedAt: new Date().toISOString()
    ...
    {
      id: 'sup-demo-004',
      companyName: 'Barloworld Equipment & Fleet Parts',
      firstName: 'Sipho',
      lastName: 'Dlamini',
      email: 'sipho.dlamini@barloworld.co.za',
      phone: '+27 11 929 0000',
      mobile: '+27 82 334 1120',
      contactPerson: 'Sipho Dlamini',
      website: 'https://www.barloworld-equipment.com',
      minedServiceWording: 'Caterpillar earthmoving parts, hydraulic components and heavy machinery support.',
      address: 'Isando, Gauteng, South Africa',
      status: 'contacted',
      type: 'supplier',
      source: 'Lead',
      updatedAt: new Date().toISOString()
    },
    {
      ...
      minedServiceWording: 'Custom interlink trailers, axles, brake systems and side-tipper spare components.',
  ...
  const fetchData = useCallback(async (limit: number = 500) => {
    ...
    try {
      ...
      // If database is still empty and no search term, populate default SA supplier registry records
      if (records.length === 0 && !searchTerm) {
        records = DEFAULT_DEMO_SUPPLIERS;
      }
  ...
  }, [searchTerm, toast, DEFAULT_DEMO_SUPPLIERS]);
