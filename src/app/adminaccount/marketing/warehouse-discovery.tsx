...
import { Copy, ClipboardCheck, Terminal, Database, ShieldCheck, Warehouse, Info, UserCheck, Zap, Target } from "lucide-react";
...
YOU MUST PERFORM A LIVE SEARCH FOR "${category} facilities in South Africa".

TASK: Discover and extract exactly 30 UNIQUE, LIVE South African storage partners for the category: "${category}".

PROTOCOL:
1. FACILITY SCAN: Identify the primary facility name and hub.
2. TECHNICAL VERIFICATION: Note specialized equipment and security features.
3. HUMAN IDENTITY: Find the ACTUAL FULL NAME of the Facility Manager or MD.
...
export default function WarehouseDiscovery() {
    return (
        <Card className="shadow-none border-none text-left text-foreground">
            <Tabs defaultValue="Cold Storage" className="w-full text-left">
                <CardHeader className="px-0 pt-0 text-left text-foreground">
                    <CardTitle className="flex items-center gap-2 font-black font-headline text-left">
                        ...
                        Warehouse Discovery Hub
                    </CardTitle>
                    <CardDescription className="text-left text-muted-foreground">Map storage capacity using noise-suppressed discovery.</CardDescription>
                </CardHeader>
