                        ...
                        <Suspense fallback={<div className="flex justify-center items-center py-20"><Loader2 className="animate-spin h-10 w-10 text-primary mx-auto" /></div>}>
                            ...
                            {activeTab === 'strategic-intro' && (
                                <div style={{ fontFamily: 'Calibri, sans-serif', fontSize: '12pt', color: '#000000', lineHeight: '1.4' }}>
                                    ...
                                    <p style={{ margin: '15pt 0' }}>Logistics Flow is a South African platform that connects over 22,000 suppliers and hauliers directly with the buyers and funders who need them, so sourcing and financing happen faster and with less legwork. We have identified a strategic fit for <strong>{currentPartner?.companyName || 'your business'}</strong> within our current expansion cycle.</p>
