...
import { Copy, ClipboardCheck, Terminal, Database, ShieldCheck, PackageSearch, Info, UserCheck, Zap, Target } from "lucide-react";
...
export default function LoadsDiscovery() {
    return (
