...
import { TagSelector, extractRegistryTags } from '@/components/ui/TagSelector';
...
export default function DriverManagement() {
  ...
  }, [allRecords, statusFilter, assigneeFilter, tagFilter]);
            ...
            <div className="space-y-6 text-left text-foreground text-foreground">
                ...
                <Card className="text-left text-foreground text-foreground">
                    <CardContent className="pt-6 text-left text-foreground text-foreground">
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6 p-4 bg-muted/30 rounded-lg text-left text-foreground text-foreground">
                            <div className="space-y-1 text-left text-foreground">
                            ...
                            <div className="space-y-1 text-left text-foreground text-foreground">
                                <TagSelector
                                    ...
                                    onValueChange={(selectedTag) => {
                                        ...
                                        console.log('Selected tag:', selectedTag, 'registry:', 'driver');
                                    }}
                                />
                            </div>
                            <div className="space-y-1 text-left text-foreground text-foreground">
