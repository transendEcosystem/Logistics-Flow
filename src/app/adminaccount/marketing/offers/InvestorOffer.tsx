...
import { DollarSign, TrendingUp, Handshake, Database, Zap, ShieldCheck, Search, ArrowRight, Info, CheckCircle2, Wallet } from 'lucide-react';
    ...
    return (
        <div className="space-y-12 text-left text-foreground">
            ...
            <div className="space-y-6">
                <div className="max-w-3xl space-y-3"><Badge className="bg-emerald-100 text-emerald-700 border-emerald-200">Strategic Network Investor Model</Badge><h2 className="text-3xl font-black font-headline uppercase">Attributable growth. <span className="text-primary">Auditable return.</span></h2><p className="text-muted-foreground leading-relaxed">A strategic network investor does not receive an informal promise. Every referred lead, converted member, earned commission, payment due date and settlement reference is recorded in the commercial ledger.</p></div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <Card><CardHeader><Handshake className="h-7 w-7 text-primary mb-2" /><CardTitle className="text-lg">1. Membership Growth</CardTitle><CardDescription>Share of qualifying Intelligence and Transaction membership revenue generated by the investor&apos;s attributed network.</CardDescription></CardHeader></Card>
                    <Card><CardHeader><Wallet className="h-7 w-7 text-primary mb-2" /><CardTitle className="text-lg">2. Product Growth</CardTitle><CardDescription>Share of retained incentives-product revenue where the investor&apos;s network converts through a designated product offer.</CardDescription></CardHeader></Card>
                    <Card><CardHeader><TrendingUp className="h-7 w-7 text-primary mb-2" /><CardTitle className="text-lg">3. Platform Economics</CardTitle><CardDescription>Supplier cashback rewards return negotiated discount value to loyal members while Logistics Flow retains at least 20%. Brokerage and origination fees are retained for platform work performed.</CardDescription></CardHeader></Card>
                </div>
                <Card className="border-primary/30 bg-primary/5"><CardContent className="p-6 grid md:grid-cols-3 gap-5"><div><p className="font-bold">Traceability</p><p className="text-sm text-muted-foreground">Lead → member → qualifying membership or product activity → ledger entry.</p></div><div><p className="font-bold">Payment discipline</p><p className="text-sm text-muted-foreground">Accrued entries become eligible on the 7th of the following month and are settled against a bank reference.</p></div><div><p className="font-bold">Platform protection</p><p className="text-sm text-muted-foreground">Brokerage and origination commissions remain retained platform revenue; they are not treated as a network-owner payout.</p></div></CardContent></Card>
                <Button asChild variant="outline"><Link href="/adminaccount?view=commercials"><CheckCircle2 className="mr-2 h-4 w-4" />Open Commercial Control & Commission Ledger</Link></Button>
            </div>
