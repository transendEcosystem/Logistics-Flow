...
export default function Commercials() {
  ...
  const settleSelected = async () => {
    ...
    try {
      ...
      toast({ title: 'Commercial Payment Run Recorded', description: `${formatCurrency(result.total)} marked paid under ${paymentReference}.` });
      setPaymentReference('');
      await loadData();
    } catch (error: any) {
  ...
  return <div className="space-y-6 text-left">
    ...
    <Tabs defaultValue="performance">
      <TabsList><TabsTrigger value="performance">Network Performance</TabsTrigger><TabsTrigger value="ledger">Commission Ledger</TabsTrigger><TabsTrigger value="payouts">Monthly Payout Run</TabsTrigger></TabsList>
