...
function JoinFormComponent() {
  ...
  useEffect(() => {
    if (authActionInitiated && !isUserLoading && user?.uid && user?.companyId) {
        ...
        const isAdmin = user.claims?.admin === true || user.email === 'mkoton100@gmail.com' || user.email === 'beyondtransport@gmail.com' || user.email === 'michael@logisticsflow.co.za' || selectedPosition === 'admin';
